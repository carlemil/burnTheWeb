  ...
  const FILTERS = [
    ...
    { id: "ascii", cpuOk: false, name: "ASCII mosaic", stage: "post", params: ["ascell", "ascmix"],
      help: "Replaces each cell with one of seven glyphs picked by its brightness, keeping the cell's colour. Halftone is the dot version of the same idea; a character grid reads quite differently.",
      defaults: { ascell: [8, 8], ascmix: [1, 1] },
      gl: src => postPass("ascii", src, u => { gl.uniform1f(u.uCell, ascCell); gl.uniform1f(u.uMix, ascMix); }) },
