  ...
  const CONTROLS = [
    ...
    { key: "rdfeed", host: "fx", group: "rd", type: "dual", label: "Feed", valId: "vRdFeed", min: 0.01, max: 0.09, step: 0.001, lo: 0.037, hi: 0.037, fmt: v => sig3(v), apply: v => rdFeed = v, durScale: 10 },
    { key: "rdkill", host: "fx", group: "rd", type: "dual", label: "Kill", valId: "vRdKill", min: 0.04, max: 0.075, step: 0.0005, lo: 0.065, hi: 0.065, fmt: v => sig3(v), apply: v => rdKill = v, durScale: 10 },
