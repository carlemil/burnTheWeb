  ...
  const CONTROLS = [
    ...
    { key: "hexsize", host: "filter", group: "f_hexpix", type: "dual", label: "Cell", valId: "vHexSize", min: 3, max: 48, step: 1, lo: 10, hi: 10, fmt: v => sig3(v) + "px", apply: v => hexSize = v, durScale: 10 },
