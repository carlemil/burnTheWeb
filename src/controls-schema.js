  ...
  const CONTROLS = [
    ...
    { key: "noise", host: "filter", group: "f_noise", type: "dual", label: "Amount", valId: "vNoise", min: 0, max: 0.3, step: 0.005, lo: 0.06, hi: 0.06, fmt: v => sig3(v * 100) + "%", apply: v => noiseAmt = v, durScale: 10 },
    { key: "noisescale", host: "filter", group: "f_noise", type: "dual", label: "Scale", valId: "vNoiseScale", min: 1, max: 24, step: 0.1, lo: 4, hi: 4, fmt: v => sig3(v), apply: v => noiseScale = v, durScale: 10 },
    { key: "noiseseed", host: "filter", group: "f_noise", type: "dual", single: true, label: "Seed", valId: "vNoiseSeed", min: 0, max: 2, step: 1, lo: 1, hi: 1, fmt: v => ["Static", "Drift", "Random"][Math.round(v)] || "Drift", apply: v => noiseSeedMode = Math.round(v), durScale: 10 },
    { key: "noisespeed", host: "filter", group: "f_noise", type: "dual", label: "Speed", valId: "vNoiseSpeed", min: 0, max: 4, step: 0.05, lo: 0.5, hi: 0.5, fmt: v => sig3(v), apply: v => noiseSpeed = v, durScale: 10 },
  ...
  const FILTER_CATS = [
    ...
    { name: "Warp & distort", desc: "move the pixels somewhere else",
      ids: ["twist", "wedge", "noise", "polar", "lens", "droste", "mirror", "shock", "barrel"] },
  ...
  const CTL_GROUPS = {
    ...
    f_twist: "Twist", f_wedge: "Wedge fold", f_noise: "Noise warp", f_glitch: "Slice glitch", f_shock: "Shockwave",
