  ...
  const CONTROLS = [
    ...
    { key: "bpdist", host: "fx", group: "bulb", type: "dual", label: "Distance", valId: "vBpDist", min: 1.3, max: 6, step: 0.05, lo: 2.5, hi: 2.5, fmt: v => sig3(v), apply: v => bpDist = v, durScale: 10 },
    { key: "bplift", host: "fx", group: "bulb", type: "dual", label: "Height", valId: "vBpLift", min: -3, max: 3, step: 0.05, lo: 0.8, hi: 0.8, fmt: v => sig3(v), apply: v => bpLift = v, durScale: 10 },
  ...
  const CTL_GROUPS = {
    ...
    attractor: "Attractor", apollo: "Apollonian gasket", mbox: "Mandelbox", gyroid: "Gyroid", voronoi: "Voronoi cells", warpnoise: "Flow noise", truchet: "Truchet tiles", shapegrid: "Shape grid", concentric: "Concentric rings", bounce: "Bouncing shapes",
