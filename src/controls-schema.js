  ...
  const CONTROLS = [
    ...
    { key: "ascset", host: "filter", group: "f_ascii", type: "dual", single: true, label: "Script", valId: "vAscSet", min: 0, max: 7, step: 1, lo: 0, hi: 0, fmt: v => ["Latin", "Arabic", "Georgian", "Japanese", "Cyrillic", "Greek", "Blocks", "Braille"][Math.round(v)] || "Latin", apply: v => ascSet = Math.round(v), durScale: 10 },
