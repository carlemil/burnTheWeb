  ...
  const HELP = {
    ...
    sliders: [
      ...
      { n: "Spin", w: "galaxy", t: "Galaxy only — how fast the disc turns; negative winds it the other way. The rotation is DIFFERENTIAL — inner stars sweep round faster than outer ones — so the arms shear and re-form as they go rather than turning as one rigid pinwheel. 0 holds the disc still." },
