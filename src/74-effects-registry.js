  ...
  const EFFECTS = [
    { id: "sirpinfyer", name: "Sierpiński", subtitle: "Sierpiński triangle · classic fire",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], band: [0, 0], bandsize: [1, 1], banddim: [65, 65], speed: [22, 74], rise: [52, 131], zoom: [0.9, 1.65], size: [1, 1.25], rot: [-2, -2], layers: 3, rpm: [0.03, 0.15], ratio: [21.5, 21.5], inrad: [0.03, 0.03], outrad: [1.05, 1.05], phase: [0, 0], points: 3850 },
    ...
    { id: "tetrafyer", name: "Tetrafyer", subtitle: "Sierpiński tetrahedron · classic fire",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], band: [0, 0], bandsize: [1, 1], banddim: [65, 65], speed: [23, 87], rise: [105, 155], zoom: [1, 1], size: [1.75, 2], rot: [-5, 5], nod: [17.2, 17.2], nodspd: [1, 1], boxsize: [4, 4], layers: 3, rpm: [0.03, 0.15], ratio: [21.5, 21.5], inrad: [0.03, 0.03], outrad: [1.05, 1.05], phase: [0, 0], points: 1500 },
    ...
    { id: "animejulia", name: "AnimeJulia", subtitle: "Julia set · animated seed",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], band: [0, 100], bandsize: [1, 5], banddim: [0, 100], speed: [92, 92], rise: [130, 130], zoom: [1, 1.65], size: [1, 1], rot: [0, 0], layers: 1, rpm: [0.28, 0.81], ratio: [8.5, 20.5], inrad: [0.03, 0.1], outrad: [1, 1.1], phase: [0, 0.052], cardx: [0, 0], points: 1500 },
    ...
    { id: "plasma", name: "Plasma", subtitle: "Plasma · sinusoidal interference",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], band: [0, 63], bandsize: [1, 3], banddim: [44, 100], zoom: [1, 1], pspeed: [0.5, 1.2], pscale: [0.9, 1.3], pwarp: [0.4, 1.5] },
    ...
    { id: "tunnel", name: "Tunnel", subtitle: "Tunnel · demoscene flythrough",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], tunspeed: [0.6, 1.6], tuntwist: [0.1, 0.5], tunrings: [8, 14], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
    ...
    { id: "metaballs", name: "Metaballs", subtitle: "Metaballs · gooey blobs",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], mbcount: [5, 5], mbradius: [0.16, 0.2], mbspeed: [0.6, 1.2], mbgain: [0.8, 1.5], zoom: [1, 1], band: [40, 70], bandsize: [1, 3], banddim: [15, 40] },
    ...
    { id: "burningship", name: "Burning Ship", subtitle: "Burning Ship · fractal",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], band: [0, 60], bandsize: [1, 4], banddim: [0, 60], zoom: [0.5, 0.62], rpm: [0.2, 0.7], ratio: [8.5, 20.5], inrad: [0.15, 0.4], outrad: [1.4, 1.9], phase: [0, 0.052], cardx: [0, 0] },
      beat: {}, extras: { palette: "0", morph: true, showBox: true, randSeed: true } },
    { id: "kaleidoscope", name: "Kaleidoscope", subtitle: "Kaleidoscope · mirrored symmetry",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], ksegments: [6, 6], krotspeed: [0.1, 0.3], knoisespeed: [0.6, 1.2], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "5", morph: true, showBox: true, randSeed: true } },
    { id: "rotozoom", name: "Rotozoomer", subtitle: "Rotozoomer · rotate + zoom",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], rzrot: [0.2, 0.6], rzzoom: [0.3, 0.7], rztile: [3, 6], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "7", morph: true, showBox: true, randSeed: true } },
    { id: "munch", name: "Munching Squares", subtitle: "Munching squares · XOR pattern",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], xorspeed: [12, 28], xorscale: [0.35, 0.5], xormask: [255, 255], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "5", morph: true, showBox: true, randSeed: true } },
    { id: "moire", name: "Moiré", subtitle: "Moiré · interference shimmer",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], mofreq: [8, 16], modrift: [0.6, 1.2], momix: [0, 0.5], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
    ...
    { id: "newton", name: "Newton", subtitle: "Newton fractal · root basins",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], nwspin: [0.05, 0.25], nwrelax: [0.9, 1.1], zoom: [0.8, 1.2], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "5", morph: true, showBox: true, randSeed: true } },
    { id: "multibrot", name: "Multibrot", subtitle: "Multibrot · power sweep",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], mbexp: [2, 4], band: [0, 100], bandsize: [1, 5], banddim: [0, 100], zoom: [1, 1.4], rpm: [0.15, 0.5], ratio: [8.5, 20.5], inrad: [0.03, 0.1], outrad: [1, 1.2], phase: [0, 0.052], cardx: [0, 0] },
    ...
    { id: "copperbars", name: "Copper Bars", subtitle: "Copper bars · raster sine bars",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], cbcount: [5, 5], cbspeed: [0.6, 1.4], cbwidth: [0.08, 0.16], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "3", morph: true, showBox: true, randSeed: true } },
    { id: "attractor", name: "Attractor", subtitle: "Strange attractor · de Jong",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], ata: [1.3, 1.5], atb: [-2.4, -2.2], atc: [2.3, 2.5], atd: [-2.2, -2.0], atjit: [0.5, 0.5], points: 6000, rise: [130, 130], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0], speed: [10, 10], size: [1, 1], rot: [0, 0], layers: 1 },
      beat: {}, extras: { palette: "7", morph: true, showBox: true, randSeed: true } },
    ...
    { id: "polygon", name: "Polygon", subtitle: "Polygon · rotating N-gon",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], pgsides: [5, 5], pgrad: [0.35, 0.35], pgthick: [1, 1], pgspin: [0.4, 0.4], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "8", morph: true, showBox: true, randSeed: true } },
    { id: "shapegrid", name: "Shape grid", subtitle: "Shape grid · pulsing lattice",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], sgcells: [9, 9], sgdot: [0.3, 0.3], sgsquare: [0, 0], sgpulse: [0.35, 0.35], sgspeed: [1.2, 1.2], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "7", morph: true, showBox: true, randSeed: true } },
    { id: "concentric", name: "Concentric rings", subtitle: "Concentric · shape tunnel",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], cosides: [6, 6], cocount: [6, 6], cothick: [0.4, 0.4], cospeed: [0.6, 0.6], cospin: [0.1, 0.1], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "1", morph: true, showBox: true, randSeed: true } },
    { id: "bounce", name: "Bouncing shapes", subtitle: "Bouncing shapes · DVD-logo drift",
      ...
      defaults: { palcycle: [8, 8], palhold: [0, 0], bncount: [4, 4], bnrad: [0.09, 0.09], bnsquare: [0.6, 0.6], bnspeed: [1, 1], zoom: [1, 1], band: [0, 0], bandsize: [1, 1], banddim: [0, 0] },
      beat: {}, extras: { palette: "2", morph: true, showBox: true, randSeed: true } },
  ];
